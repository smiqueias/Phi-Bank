...
class StatementeErrorScreen extends StatelessWidget {
  const StatementeErrorScreen({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Center(
            child: ElevatedButton(
              onPressed: () {
                Provider.of<IUserBalanceVM>(context, listen: false).getUserBalance();
                Provider.of<IUserStatementVM>(context, listen: false).getUserStatement();
              },
              child: const Text(
                "Tentar novamente",
